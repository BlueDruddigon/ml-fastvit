...
def validate(args):
    ...
    # create model
    model = create_model(
        args.model, pretrained=args.pretrained, num_classes=args.num_classes, in_chans=3, global_pool=args.gp, scriptable=args.torchscript, inference_mode=args.use_inference_mode
    )
...
def write_results(results_file: str, results) -> None:
